...
pub use sys::mbedtls_gcm_auth_decrypt as gcm_auth_decrypt;
pub use sys::mbedtls_gcm_crypt_and_tag as gcm_crypt_and_tag;
pub use sys::mbedtls_gcm_finish as gcm_finish;
pub use sys::mbedtls_gcm_free as gcm_free;
pub use sys::mbedtls_gcm_init as gcm_init;
pub use sys::mbedtls_gcm_self_test as gcm_self_test;
pub use sys::mbedtls_gcm_setkey as gcm_setkey;
pub use sys::mbedtls_gcm_starts as gcm_starts;
pub use sys::mbedtls_gcm_update as gcm_update;
pub use sys::mbedtls_gcm_update_ad as gcm_update_ad;
